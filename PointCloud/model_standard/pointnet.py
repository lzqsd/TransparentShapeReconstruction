...
class PointNetRefinePoint(nn.Module):
    def __init__(self ):
        ...
        self.sa1 = PointNetSetAbstraction(1024, 0.1, 64, 6 + 3, [64, 64], [4, 4] )
        self.sa2 = PointNetSetAbstraction(256, 0.2, 32, 64 + 3, [128, 128], [8, 8] )
        self.sa3 = PointNetSetAbstraction(64, 0.4, 32,  128 + 3, [256, 256], [16, 16] )
        self.sa4 = PointNetSetAbstraction(16, 0.8, 32, 256 + 3, [512, 512], [32, 32] )

        self.fp4 = PointNetFeaturePropagation(771, [512, 256], [32, 16] )
        self.fp3 = PointNetFeaturePropagation(387, [256, 128], [16, 8] )
        self.fp2 = PointNetFeaturePropagation(195, [128, 64], [8, 4] )
        self.fp1 = PointNetFeaturePropagation(73, [64], [4] )
